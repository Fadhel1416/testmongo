...
$collection = $db->campagne;
    ...
    if (isset($_POST["ajouter"]) && !empty($_POST["firstname"]) && !empty($_POST["secondname"]) && !empty($_POST["rl"])) {
      
        $cursor=$collection->insertOne(
           array("name"=>htmlspecialchars($_POST["firstname"]),
"secondname"=>htmlspecialchars($_POST["secondname"]),
"rl"=>htmlspecialchars($_POST["rl"]),
"userId"=>"2"
));
        $message="Nouvelle compagne a éte ajouter";
...
<body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white">
     ...
     <form action="ajouter_compagne.php" class="form" method="POST">
<div class="form-group">
...
<div class="form-group">
    ...
    <input type="text" name="rl" class="form-control" required >
    </div>
